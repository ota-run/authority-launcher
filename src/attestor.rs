...
impl AttestationIssuer {
    ...
    pub(crate) fn for_capability_observation_test(signing_key: SigningKey) -> Self {
        ...
        let mut binding = LauncherAttestationProducerBindingV1 {
            ...
            socket_path: ota_authority_protocol::SYSTEMD_ATTESTOR_SOCKET_PATH_V1.into(),
            service_unit: ota_authority_protocol::SYSTEMD_ATTESTOR_SERVICE_UNIT_V1.into(),
            launcher_service_unit: ota_authority_protocol::SYSTEMD_LAUNCHER_SERVICE_UNIT_V1.into(),
